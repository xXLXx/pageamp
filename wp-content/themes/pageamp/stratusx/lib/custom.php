...
add_action( 'elementor/widget/render_content', 'th_wrap_sidebar_container', 10, 2 );

function th_wrap_sidebar_container( $content, $widget ) {
    ...
    if(is_object($widget)){
        ...
        if ( 'sidebar' === $widget->get_name() ) {
            $tmp_content = $content;
            $content = '<div class="sidebar th-widget-area th-sidebar-widget FAK">';
            $content .= $tmp_content;
            $content .= '</div>';
        }
    }
